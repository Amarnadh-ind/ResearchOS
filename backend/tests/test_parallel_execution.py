...
def test_parallel_executor_functions_exist():
    ...
    assert callable(_citation_novelty_parallel_executor), (
        "citation_novelty parallel executor not callable"
    )
...
async def test_async_functions():
    ...
    assert asyncio.iscoroutinefunction(_citation_novelty_parallel_executor), (
        "citation_novelty executor should be async"
    )
